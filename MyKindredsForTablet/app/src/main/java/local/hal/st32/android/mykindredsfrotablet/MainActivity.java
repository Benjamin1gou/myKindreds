...
import static local.hal.st32.android.mykindredsfrotablet.Voice.*;
...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherIcon = (ImageView)findViewById(R.id.whetherIcon);
    ...
    public void viewUpdate(){
        StartFunction start = new StartFunction(MainActivity.this);
        start.start();
    }
